 ...
 * @see
 */
public final class BitOr extends AbstractBinaryOperator {

    public BitOr(final int line, final int column, final AbstractExpression expression1, final AbstractExpression expression2) {
