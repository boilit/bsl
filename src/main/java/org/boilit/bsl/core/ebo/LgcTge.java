 ...
 * @see
 */
public final class LgcTge extends AbstractBinaryOperator {

    public LgcTge(final int line, final int column, final AbstractExpression expression1, final AbstractExpression expression2) {
