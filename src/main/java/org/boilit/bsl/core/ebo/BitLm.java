 ...
 * @see
 */
public final class BitLm extends AbstractBinaryOperator {

    public BitLm(final int line, final int column, final AbstractExpression expression1, final AbstractExpression expression2) {
        super(line, column, expression1, expression2);
    }

    @Override
    public final Object execute(final ExecuteContext context) throws Exception {
        return Operation.doBitLm(this,
