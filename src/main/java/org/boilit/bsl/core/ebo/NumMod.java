 ...
 * @see
 */
public final class NumMod extends AbstractBinaryOperator {

    public NumMod(final int line, final int column, final AbstractExpression expression1, final AbstractExpression expression2) {
