 ...
 * @see
 */
public final class BitZrm extends AbstractBinaryOperator {

    public BitZrm(final int line, final int column, final AbstractExpression expression1, final AbstractExpression expression2) {
        super(line, column, expression1, expression2);
    }

    @Override
    public final Object execute(final ExecuteContext context) throws Exception {
        return Operation.doBitZrm(this,
