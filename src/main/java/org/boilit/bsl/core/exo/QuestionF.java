 ...
 * @see
 */
public final class QuestionF extends AbstractOperator {
    protected AbstractExpression expression1;
    protected AbstractExpression expression2;

    public QuestionF(final int line, final int column, final AbstractExpression exp1, final AbstractExpression exp2) {
        super(line, column);
    ...
    public Object execute(final ExecuteContext context) throws Exception {
        ...
        return Operation.toBool(value)? value : expression2.execute(context);
    }
