...
public final class NumNgt extends AbstractUnitaryOperator {
    ...
    public NumNgt(final int line, final int column, final AbstractExpression expression, final ITemplate template) {
    ...
    public final AbstractExpression optimizeConst() throws Exception {
        return new Value(
                this.getLine(),
                this.getColumn(),
                Operation.doNumNgt(this, this.getExpression().execute(null)),
                this.getTemplate()
        );
    }
}
