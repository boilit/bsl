 ...
 * @see
 */
public final class BitZrmAssign extends AbstractAssignOperator {
    public BitZrmAssign(final int line, final int column, final String label, final AbstractExpression expression) {
    ...
    protected final Object executeFragment(final Object value1, final Object value2) throws Exception {
        return Operation.doBitZrm(this, value1, value2);
    }
}
