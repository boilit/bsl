 ...
 * @see
 */
public final class NumModAssign extends AbstractAssignOperator {
    public NumModAssign(final int line, final int column, final String label, final AbstractExpression expression) {
