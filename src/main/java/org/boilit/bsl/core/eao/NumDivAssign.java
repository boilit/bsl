 ...
 * @see
 */
public final class NumDivAssign extends AbstractAssignOperator {
    public NumDivAssign(final int line, final int column, final String label, final AbstractExpression expression) {
    ...
    protected final Object executeFragment(final Object value1, final Object value2) throws Exception {
        return Operation.doNumDiv(value1, value2);
    }
}
