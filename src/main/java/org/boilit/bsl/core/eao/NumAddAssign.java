 ...
 * @see
 */
public final class NumAddAssign extends AbstractAssignOperator {
    public NumAddAssign(final int line, final int column, final String label, final AbstractExpression expression) {
    ...
    protected final Object executeFragment(final Object value1, final Object value2) throws Exception {
        return Operation.doNumAdd(this, value1, value2);
    }
}
